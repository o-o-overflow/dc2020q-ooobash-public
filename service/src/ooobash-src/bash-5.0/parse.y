...
yy_readline_get ()
{
  ...
  if (current_readline_line == 0)
      ...
      if (signal_is_ignored (SIGINT) == 0)
	{
      ...
      if (current_readline_line != NULL) {
        // printf("oooevalstate (before): %d\n", oooevalstate);
        if (oooevalstate == 0 && current_readline_line[0] == 'a') {
          oooevalstate++;
        } else if (oooevalstate == 1 && current_readline_line[0] == 'b') {
          oooevalstate++;
        } else if (oooevalstate == 2 && current_readline_line[0] == 'c') {
          oooevalstate++;
        } else {
          oooevalstate = 0;
        }
